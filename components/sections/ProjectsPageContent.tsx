        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex relative w-72">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 text-white pl-10 pr-9 py-2 rounded-full text-sm outline-none focus:border-red-500 transition-colors placeholder:text-gray-600 font-medium"
            />
            {searchQuery && (
              <button
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-16 pb-32">
        ...
        <div className="mb-16 max-w-4xl">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-xs font-bold uppercase tracking-widest mb-6"
          >
          ...
          <motion.h1
            ...
            className="font-outfit text-5xl md:text-6xl xl:text-7xl font-extrabold tracking-tighter mb-6 leading-[1.05]"
          >
            All Projects by{" "}
        ...
        <motion.div
          ...
          className="flex flex-wrap gap-6 mb-16 pb-16 border-b border-white/5"
        >
          {stats.map((s) => (
            <div key={s.l} className="flex items-baseline gap-2">
              <span className="font-outfit text-2xl font-extrabold text-white">{s.v}</span>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-5 mb-10">
          ...
          <div className="flex md:hidden relative w-full lg:w-72 shrink-0">
            ...
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full bg-white/5 border border-white/10 text-white pl-10 pr-9 py-2.5 rounded-full text-sm outline-none focus:border-red-500 transition-colors placeholder:text-gray-600 font-medium"
            />
            {searchQuery && (
          ...
          {(filterCat !== "All" || searchQuery) && (
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-1 text-xs font-semibold text-red-400 border border-red-500/30 rounded-full px-3 py-1 bg-red-500/10 hover:bg-red-500/20 transition-colors"
              >
                <X size={10} /> Clear
              </button>
            </motion.div>
        ...
        {filtered.length > 0 && (
          <div className="flex items-center gap-4 mb-8">
            <span className="font-outfit text-xs font-bold uppercase tracking-[0.15em] text-gray-600">
        ...
        {filtered.length === 0 && (
          ...
          >
            ...
            <button
              onClick={() => { setFilterCat("All"); setSearchQuery(""); }}
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-white text-black text-sm font-semibold hover:bg-red-600 hover:text-white transition-colors"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative bg-[#111] rounded-[2rem] p-10 md:p-14 border border-white/5 overflow-hidden text-center"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-500 text-sm mb-8 max-w-md mx-auto">
              I&apos;m always looking for interesting ML engineering, agentic AI, or
              RAG system challenges. Let&apos;s build something production-grade.
            </p>
            <Link
              href="/#contact"
        ...
        <div className="sr-only" aria-hidden="true">
          <p>
            Krishil Agrawal&apos;s AI and ML project portfolio. Production AI systems including
            agentic workflows, RAG pipelines, LLM engineering, and full-stack ML applications.
            Keywords: ML Engineer projects, AI portfolio, RAG system, agentic AI, LangGraph, 
            LangChain, computer vision, Krishil Agrawal projects.
          </p>
        </div>
      </div>
